...
?>
		<div>
			<fieldset>
				<legend><?php echo JText::_('CC UPDATE SUMMARY');?>
				<div style="color: red"><?php echo JText::_('CC YOU ARE CURRENTLY RUNNING ON AN OLDER VERSION OF JOM SOCIAL');?></div>
...
?>
		<div>
			<fieldset>
				<legend><?php echo JText::_('CC UPDATE SUMMARY');?>
				<div style="margin: 3px"><?php echo JText::_('CC YOU ARE CURRENTLY RUNNING THE LATEST VERSION OF JOM SOCIAL'); ?></div>
...
<?php
	...
	function _getLocalVersionNumber()
	{
		$versionString	= $this->_getLocalVersionString();
		$tmpArray		= explode( '.' , $versionString );
	...
	function _getCurrentVersionData()
	{
	...
	function _getLocalVersionString()
	{
		static $version		= '';
