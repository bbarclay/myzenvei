...
class CommunityController extends JController
{
	function __construct()
	{
		...
		if( $task != 'azrul_ajax' )
		{
			$document->addScript( COMMUNITY_BASE_ASSETS_URL . '/jquery-1.3.2.pack.js' );
	...
	function savePublish()
	{
		...
		$table	=& JTable::getInstance( $viewName , 'CommunityTable' );
	 ...
	 **/
	function ajaxTogglePublish( $id, $field , $viewName )
	{
