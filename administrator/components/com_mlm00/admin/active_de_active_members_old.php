...
if($_GET['mode']=="active")
{
	...
	$lid2 =mysql_query("SELECT SUM(left_id) FROM ".$mem_name." WHERE cycle_id =".$cycle_id."") or die(mysql_error());
	$lresult = mysql_result($lid2, 0);
	$lid=$lresult;
	
	$rid2  =mysql_query("SELECT SUM(right_id) FROM ".$mem_name." WHERE cycle_id =".$cycle_id."") or die(mysql_error());
            ...
            <td width="77%" valign="top" bgcolor="#FFFFFF"> <br><br>
             <form method="post" action="" name="articlelist">
              <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D4D4C8">
				...
				<a href="<? print "view_aging2.php?>"><?=$mem_name;?>&nbsp; </font></td>
...
<a href="<? print "active_de_active_members.php?mode=deactive&mem_name=".$mem_name."&enrolled_id=".$enrolled_id;?>">Deactive</a>								
					 </td>
