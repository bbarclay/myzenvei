...
<div id="editcell">
    <table class="adminlist">
        ...
        <tr>
            ...
            <th align="left" class="title">{$smarty.const._HWDPS_CVACCESS}</th>
            <th align="left" class="title">{$smarty.const._HWDPS_CUACCESS}</th>
            <th align="left" width="50" class="title">{$smarty.const._HWDPS_PUB}</th>
            <th align="left" width="30" class="title">{$smarty.const._HWDPS_ORDER}</th>
            <th align="left" width="40" class="title" colspan="2">{$smarty.const._HWDPS_REORDER}</th>
        </tr>
        </thead>
        <tbody>
	...
	<tfoot>
	<tr><td colspan="9" align="center"><div style="float:right;">{$writePagesCounter}</div>{$writePagesLinks}</td></tr>
	</tfoot>
    </table>
</div>
