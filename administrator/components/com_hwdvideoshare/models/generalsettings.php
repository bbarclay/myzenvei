  		...
  		<div style="width:100%;margin-top:5px;text-align:left;">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  <tr>
			    ...
			    if (is_callable('exec') && function_exists('exec')) {
			    	echo "<img src=\"components/com_hwdvideoshare/images/tick.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The exec() function <font color=\"green\"><b>is available</b></font><br />";
			    } else {
			    	echo "<img src=\"components/com_hwdvideoshare/images/delete.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The exec() function <font color=\"red\"><b>is not available</b></font><br />";
			    }
			    if (is_callable('curl_init') && is_callable('curl_exec') && function_exists('curl_init') && function_exists('curl_exec')) {
			    	echo "<img src=\"components/com_hwdvideoshare/images/tick.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The cURL library <font color=\"green\"><b>is available</b></font><br />";
			    } else {
			    	echo "<img src=\"components/com_hwdvideoshare/images/delete.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The cURL library <font color=\"red\"><b>is not available</b></font><br />";
			    }
			    if (is_callable('fsockopen') && function_exists('fsockopen')) {
			    	echo "<img src=\"components/com_hwdvideoshare/images/tick.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The fsockopen() function <font color=\"green\"><b>is available</b></font><br />";
			    } else {
			    	echo "<img src=\"components/com_hwdvideoshare/images/delete.png\" border=\"0\" alt=\"\" title=\"\" style=\"padding:1px 5px;vertical-align:bottom;\" />The fsockopen() function <font color=\"red\"><b>is not available</b></font><br />";
			    }
			    ?>
			    </td>
			  </tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  ...
			  <tr>
				...
				<option value="default|default"<?php if ($c->hwdvids_template_path == "default") echo " selected=\"selected\""; ?>><?php echo _ADMIN_HWDVIDS_DEFAULT_TEMPLATE ?></option>
				<?php
				$query = 'SELECT *'
					. ' FROM #__plugins'
					. ' WHERE published = 1'
			  ...
			  <tr>
				...
				<option value="english|english" <?php if ($c->hwdvids_language_path == "english") echo "selected=\"selected\"" ?>><?php echo _ADMIN_HWDVIDS_LANGUAGE_ENGLISH ?></option>
				<?php
				$query = 'SELECT *'
					. ' FROM #__plugins'
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3>High Quality Videos</h3></td></tr>
			  <tr>
				<td width="20%" align="left" valign="top">Use HQ Videos?</td>
				<td width="20%" align="left" valign="top">
				<select name="usehq" size="1" class="inputbox">
					<option value="1"<?php if ($c->usehq == 1) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_YES.' '; ?></option>
					<option value="0"<?php if ($c->usehq == 0) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_NO.' '; ?></option>
				</select>
				</td>
				<td width="60%" align="left" valign="top">Try to use HQ video if available.</td>
			  </tr>
			</table>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  ...
			  <tr>
				...
				if ($check_direct == true) {
					echo "<div style=\"border:1px solid #458B00;color:#458B00;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/tick.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH1." "._HWDVIDS_ALERT_AC_YES."</div>";
				} else {
					echo "<div style=\"border:1px solid #c30;color:#c30;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/delete.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH1." "._HWDVIDS_ALERT_AC_NO."</div>";
				}
				?>
			    </td>
			  </tr>
			  <tr>
				...
				if ($check_wget01 == true) {
					echo "<div style=\"border:1px solid #458B00;color:#458B00;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/tick.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH2." "._HWDVIDS_ALERT_AC_YES."</div>";
				} else {
					echo "<div style=\"border:1px solid #c30;color:#c30;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/delete.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH2." "._HWDVIDS_ALERT_AC_NO."</div>";
				}
				?>
			    </td>
			  </tr>
			  <tr>
				...
				if ($check_wget02 == true) {
					echo "<div style=\"border:1px solid #458B00;color:#458B00;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/tick.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH3." "._HWDVIDS_ALERT_AC_YES."</div>";
				} else {
					echo "<div style=\"border:1px solid #c30;color:#c30;margin: 0;padding: 5px;font-weight: bold;\"><img src=\"".$mosConfig_live_site."/administrator/components/com_hwdvideoshare/images/delete.png\" style=\"vertical-align:center\" />&nbsp;"._HWDVIDS_ALERT_ACMETH3." "._HWDVIDS_ALERT_AC_NO."</div>";
				}
				?>
			    </td>
			  </tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  ...
			  <tr>
				...
				<td width="20%" align="left" valign="top">
				<select name="disablelocupld" size="1" class="inputbox" onChange="disable_enable()">
			...
			<table cellpadding="0" cellspacing="3" border="0" width="100%">
			  <tr>
				...
				<td width="20%" align="left" valign="top">
				<select name="locupldmeth" size="1" class="inputbox" id="locupldmeth" <?php if ($c->disablelocupld == 1) { ?> disabled="disabled"<?php } ?>>
			...
			<div style="border:1px solid #c30;color:#333333;background:#f3ece9;margin: 0 0 5px 0;padding: 5px;"><?php echo _ADMIN_HWDVIDS_SETT_UPLDMETH_BASPHP ?></div>
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			...
			<div style="margin:1px;padding:1px;"><br />
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3><?php echo _ADMIN_HWDVIDS_SETT_AUTOCON ?></h3></td></tr>
			  <tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h2>High Quality Conversion Settings</h2></td></tr>
			  <tr>
			  ...
			  <tr>
				...
				<td width="80%" align="left" valign="top" colspan="2">Create high quality MP4 videos with the libx264 codec.</td>
			  </tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  ...
			  <tr>
				<td width="20%" align="left" valign="top"></td>
				<td width="80%" align="left" valign="top" colspan="2"><?php echo _ADMIN_HWDVIDS_SETT_CNVTPROG_DESC ?></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<select name="cnvt_asr" size="1" class="inputbox">
					<option value="8000"<?php if ($c->cnvt_asr == 8000) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_TELE; ?></option>
					...
					<option value="32000"<?php if ($c->cnvt_asr == 32000) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_MINIDV; ?></option>
					<option value="44056"<?php if ($c->cnvt_asr == 44056) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_NTSC; ?></option>
					<option value="44100"<?php if ($c->cnvt_asr == 44100) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_CD; ?></option>
					<option value="47250"<?php if ($c->cnvt_asr == 47250) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_PCM; ?></option>
					<option value="48000"<?php if ($c->cnvt_asr == 48000) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_DTV; ?></option>
					<option value="50000"<?php if ($c->cnvt_asr == 50000) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_ASR_AREC; ?></option>
				</select>
				</td>
			  </tr>
			  <tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3><?php echo _ADMIN_HWDVIDS_SETT_JACLINT ?></h3></td></tr>
			  <tr>
				<td width="20%" align="left" valign="top"><b><?php echo _ADMIN_HWDVIDS_SETT_INTJACL ?></b></td>
				<td width="20%" align="left" valign="top">
				<select name="jaclint" size="1" class="inputbox">
					<option value="1"<?php if ($c->jaclint == 1) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_YES.' '; ?></option>
					<option value="0"<?php if ($c->jaclint == 0) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_NO.' '; ?></option>
				</select>
				</td>
				<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_INTJACL_DESC ?></td>
			  </tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3><?php echo _ADMIN_HWDVIDS_SETT_INTEGRATIONSGJ ?></h3></td></tr>
			  <tr>
				<td width="20%" align="left" valign="top"><b><?php echo _ADMIN_HWDVIDS_SETT_INTGJ ?></b></td>
				<td width="20%" align="left" valign="top">
				<select name="gjint" size="1" class="inputbox" disabled="disabled">
					<option value="1"<?php if ($c->gjint == 1) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_YES.' '; ?></option>
					<option value="0"<?php if ($c->gjint == 0) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_NO.' '; ?></option>
				</select>
				</td>
				<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_INTGJ_DESC ?></td>
			  </tr>
			</table>
			</div>
			<?php
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3><?php echo _ADMIN_HWDVIDS_SETT_ACCESSSET ?></h3></td></tr>
			  <tr>
				<td width="20%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_ACCESSMETHOD; ?></td>
				<td width="20%" align="left" valign="top">
				<select name="access_method" size="1" class="inputbox" onChange="ShowAccessPane()">
					<option value="0"<?php if ($c->access_method == 0) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_ACCESSGRP.' '; ?></option>
					<option value="1"<?php if ($c->access_method == 1) { ?> selected="selected"<?php } ?>><?php echo _ADMIN_HWDVIDS_SETT_ACCESSLEV.' '; ?></option>
				</select>
				</td>
				<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_ACCESSMETHOD_DESC ?></td>
			  </tr>
			</table>
			</div>
			<div id="groupaccess" <?php if ($c->access_method == 1 && $c->jaclint == 1) { ?> style="visibility: hidden; height: 0px;"<?php } ?>>
				<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
				  <tr><td align="left" valign="top" colspan="3"><h3><?php echo _ADMIN_HWDVIDS_SETT_MAINACCESS ?></h3></td></tr>
				  <tr>
				  ...
				  <tr>
					<td width="20%" align="left" valign="top"><b><?php echo _ADMIN_HWDVIDS_SETT_BVIIC ?></b></td>
					<td width="20%" align="left" valign="top">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
				  <tr><td align="left" valign="top" colspan="3"><h3>Moderator Access</h3></td></tr>
				  <tr>
					<td width="20%" align="left" valign="top"><b>Moderator Group</b></td>
					<td width="20%" align="left" valign="top">
					<?php
					$gtree_core = JHTML::_('select.genericlist', $gtree, 'gtree_mdrt', 'size="4"', 'value', 'text', $c->gtree_mdrt);
					echo $gtree_core;
					?>
					</td>
			...
			<div id="levelaccess" <?php if ($c->access_method == 0 || $c->jaclint == 0) { ?> style="visibility: hidden; height: 0px;"<?php } ?>>
				<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
				  ...
				  <tr>
					...
					<td width="20%" align="left" valign="top">
					<?php
					$main_access = hwd_vs_tools::hwdvsMultiAccess( $c->accesslevel_main, 'accesslevel_main[]' );
					echo $main_access;
					?>
					</td>
					<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_MAINCOMACCESS_DESC ?></td>
				  ...
				  <tr>
					...
					<td width="20%" align="left" valign="top">
					<?php
					$upld_access = hwd_vs_tools::hwdvsMultiAccess( $c->accesslevel_upld, 'accesslevel_upld[]' );
					echo $upld_access;
					?>
					</td>
					<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_UPLOADACCESS_DESC ?></td>
				  ...
				  <tr>
					...
					<td width="20%" align="left" valign="top">
					<?php
					$plyr_access = hwd_vs_tools::hwdvsMultiAccess( $c->accesslevel_plyr, 'accesslevel_plyr[]' );
					echo $plyr_access;
					?>
					</td>
					<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_PLAYERACCESS_DESC ?></td>
				  ...
				  <tr>
					...
					<td width="20%" align="left" valign="top">
					<?php
					$grps_access = hwd_vs_tools::hwdvsMultiAccess( $c->accesslevel_grps, 'accesslevel_grps[]' );
					echo $grps_access;
					?>
					</td>
					<td width="60%" align="left" valign="top"><?php echo _ADMIN_HWDVIDS_SETT_GROUPACCESS_DESC ?></td>
