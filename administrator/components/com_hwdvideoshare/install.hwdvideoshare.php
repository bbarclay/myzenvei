...
function com_install() {
	...
	$mainframe->addCustomHeadTag('<link rel="stylesheet" href="'.JURI::root( true ).'/administrator/components/com_hwdvideoshare/assets/css/installer.css" type="text/css" />');
	...
	<div class="installer_box">
		<h2>hwdVideoShare [ Dannevirke ]</h2>
	...
	<div class="installer_box">
		...
		$HWDUpgrades[0]['updates'][12] = "ALTER TABLE `#__hwdvidsplugin` CHANGE `client_id` `client_id` SMALLINT( 3 ) NOT NULL default '0'";
		...
		$HWDUpgrades[2]['updates'][17] = "ALTER TABLE `#__hwdvidsplugin` ADD `website` text DEFAULT '' NOT NULL AFTER `checked_out_time`";
		$HWDUpgrades[2]['updates'][18] = "ALTER TABLE `#__hwdvidsplugin` ADD `playlist_compat` TINYINT ( 1 ) DEFAULT '0' NOT NULL AFTER `checked_out_time`";
