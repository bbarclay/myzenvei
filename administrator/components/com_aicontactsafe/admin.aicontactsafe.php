...
function setSubMenu($sTask = '') {
	...
	JSubMenuHelper::addEntry(JText::_('Attachments'), 'index.php?option=com_aicontactsafe&sTask=attachments', $sTask == 'attachments');
	...
	JSubMenuHelper::addEntry(JText::_('Message statuses'), 'index.php?option=com_aicontactsafe&sTask=statuses', $sTask == 'statuses');
