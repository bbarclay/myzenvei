		...
		<table border="0" cellpadding="0" cellspacing="2">
			<tr>
				...
				<td>
					...
					<button onclick="document.getElementById('filter_string').value='';document.getElementById('filter_email').value='';document.getElementById('filter_subject').value='';document.getElementById('filter_profile').value='0';document.getElementById('filter_status').value='<?php echo $this->_config_values['default_status_filter']; ?>';document.getElementById('filter_order').value='';document.getElementById('filter_order_Dir').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
				</td>
			</tr>
		</table>
	</td></tr>
...
<thead>
	<tr>
		...
		<th width="60" nowrap="nowrap">
			<?php echo JHTML::_('grid.sort', JText::_( 'Status' ), 'status', @$this->filter_order_Dir, @$this->filter_order ); ?>
		</th>
		<th width="120">
			<?php echo JHTML::_('grid.sort', JText::_( 'Sent to' ), 'email_destination', @$this->filter_order_Dir, @$this->filter_order ); ?>
		</th>
