...
<table>
	<tr><td width="100%"><h3><?php echo JText::_( 'Profiles' ); ?></h3></td></tr>
	<tr><td>
...
<thead>
	<tr>
		...
		<th width="80" nowrap="nowrap">
			<?php echo JHTML::_('grid.sort', JText::_( 'Default' ), 'set_default', @$this->filter_order_Dir, @$this->filter_order ); ?>
		</th>
		<th width="80" nowrap="nowrap">
