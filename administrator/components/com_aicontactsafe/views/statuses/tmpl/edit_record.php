...
<fieldset class="adminform">
	<legend><?php echo JText::_( 'Message status' ); ?></legend>
	<table id="type">
		<tr>
			<td class="key">
				<?php echo JText::_( 'Status name' ); ?>:
			</td>
			<td class="space">&nbsp;</td>
			<td class="value">
		...
		<tr>
			...
			<td class="value">
				...
				<img src="<?php echo JURI::root();?>administrator/components/com_aicontactsafe/includes/fcp/sel.gif" onclick="showColorGrid2('color','color_sample');" border="0" style="cursor:pointer" alt="<?php echo JText::_( 'Select color' ); ?>" title="<?php echo JText::_( 'Select color' ); ?>">
			</td>
		</tr>
		<tr>
			<td class="key">
