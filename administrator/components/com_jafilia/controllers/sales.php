 ...
 */
class JafiliaControllerSales extends JController //JafiliaController
{
   /**
...
*/
   ...
   function save()
   {
      ...
      $link = 'index.php?option=com_jafilia&controller=sales';
...
*/
   ...
   function remove()
   {
      ...
      $this->setRedirect( 'index.php?option=com_jafilia&controller=sales', $msg );
   }// function
	function unpublish()
	{
		...
		$this->setRedirect( 'index.php?option=com_jafilia&controller=sales' );
	}   
	*/
	/*
   function publish()
   ...
   /*
	...
	function payout()  {
      ...
      if(!$model->payout()) {
		...
		'http://127.0.0.1/joomla_1.5.10-stable-full_package-test/administrator/index.php?option=com_jafilia&controller=sales&task=edit&cid[]=5';
		//$this->setRedirect( 'index.php?option=com_jafilia&controller=sales', $msg );
		$this->setRedirect( 'index.php?option=com_jafilia&controller=sales&task=edit&cid[]='.$_GET['uid'], $msg );
	}
	*/
   function cancel()
   {
