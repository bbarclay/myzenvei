 ...
 */
class JafiliaControllerClicks extends JController //JafiliaController
{
   /**
   ...
   function save()
   {
      ...
      $link = 'index.php?option=com_jafilia&controller=clicks';
   ...
   function remove()
   {
      ...
      $this->setRedirect( 'index.php?option=com_jafilia&controller=clicks', $msg );
   }// function
	function unpublish()
	{
		...
		$this->setRedirect( 'index.php?option=com_jafilia&controller=clicks' );
	}   
   function publish()
   {
 		// Check for request forgeries
   ...
   /*
	...
	function payout()  {
      ...
      if(!$model->payout()) {
		...
		'http://127.0.0.1/joomla_1.5.10-stable-full_package-test/administrator/index.php?option=com_jafilia&controller=clicks&task=edit&cid[]=5';
		//$this->setRedirect( 'index.php?option=com_jafilia&controller=clicks', $msg );
		$this->setRedirect( 'index.php?option=com_jafilia&controller=clicks&task=edit&cid[]='.$_GET['uid'], $msg );
	}
   function cancel()
   {
