...
//		$cpanel_images->newcampaign = $this->CpanelButton('configuration48.jpg', 'index.php?option=com_jafilia&controller=campaigns&task=new', JText::_('JAF_NEW_CAMPAIGN'));
		...
		$cpanel_images->help = $this->CpanelButton('help48.jpg', 'index.php?option=com_jafilia&controller=help', JText::_('JAF_HELP'));
		...
		$cpanel_images->charts = $this->CpanelButton('charts48.png', 'index.php?option=com_jafilia&controller=charts', JText::_('JAF_CHARTS'));
