	...
	if($myzDb->query("select * from jos_fixed_reg_fee where userid='$userid'") && $myzDb->rowCount()>0)
		{
			...
			$regFeeDate = date("m/d/Y", strtotime($myzRegFee['regdate']));
			$nextPaymentDate = date("m/d/Y", strtotime($myzRegFee['nextpaymentdate']));
...
<table border="0" align="center" cellpadding="2" cellspacing="2" class="display" id="example" style="margin-top:10px; margin-left:20px; width:50%">
	<thead>
	<tr>
	  <td colspan="5"><span class="style2"><? if(!empty($error_msg)) echo $row['username'] . "'s ". $error_msg; ?></span></td>
	  </tr>
	<tr style= "background-color: #FF6600; color:#FFFFFF;">	
     <td colspan="5"><strong>Change Options </strong></td>
    </tr>
  </thead>
	 <tbody>
	  <tr>
	    <td colspan="5"><span class="style2"><?php 
	  ...
	  <tr>
	    <td colspan="5"><strong>Change Products Quantity</strong></td>
       </tr>
	  <tr>
	    <td width="22%">Zenvei Red </td>
	    <td width="26%"><input name="qnt_red" type="text" id="qnt_red" size="2" value="<? echo $ZENVEI_RED; ?>" /></td>
	    <td width="23%">Zenvei Blue</td>
	    <td width="26%" colspan="2"><input name="qnt_blu" type="text" id="qnt_blu" size="2" value="<? echo $ZENVEI_BLUE; ?>"/></td>
       </tr>
	  <tr>
	    <td width="22%">Zenvei Green</td>
	    <td width="26%"><input name="qnt_gre" type="text" id="qnt_gre" size="2" value="<? echo $ZENVEI_GREEN; ?>"/></td>
	    <td width="23%">Zenvei Silver</td>
	    <td width="26%" colspan="2"><input name="qnt_sil" type="text" id="qnt_sil" size="2" value="<? echo $ZENVEI_SILVER; ?>"/></td>
       </tr>
	   <tr>
	    <td colspan="6">&nbsp;</td>
       </tr>
        <tr>
	    <td colspan="6"><strong>Registeration Fee</strong></td>
       </tr>
       <tr>
	    <td>Last Payment Date </td>
	    <td><input type="text" name="regfee_fdate" id="regfee_fdate" value="<?php echo $regFeeDate;?>"></td>
	    <td>Next Payment Date</td>
	    <td colspan="4"><input type="text" name="regfee_ndate" id="regfee_ndate" value="<?php echo $nextPaymentDate;?>"></td>
       </tr>
        <tr>
	    <td>Reg. Fee</td>
	    <td>$<input type="text" name="regfee" id="regfee" value="<?php echo $regFee;?>" size=10 /></td>
	    <td colspan="4">&nbsp;</td>
       </tr>
      <tr>
	    <td colspan="6">&nbsp;</td>
	  ...
	  <tr>
	    <td colspan="5"><strong>Change Prefferences</strong></td>
       </tr>
	  <tr>
	    <td width="22%">AutoShip Date</td>
	    <td width="26%">
	    ...
	    <td width="13%">Shipping Type </td>
	    
	    <td width="12%"><select name="ship_method" id="ship_method">
	  ...
	  <tr>
	    <td colspan="5" height="24"><strong>Update CreditCard Information </strong></td>
       </tr>
	  <tr>
	    <td width="22%">Card Type</td>
	    <td width="26%"> 
		<?php 
	    ...
	    <td width="23%">Name on Card</td>
	    <td width="26%" colspan="2"><input name="name_card" type="text" id="name_card" value="<?php echo $vm_name_oncard; ?>"/></td>
       </tr>
	  <tr>
	    <td width="22%">Card Number:</td>
	    <td width="26%"><input name="card_no" type="text" id="card_no" maxlength="18"  value="<?php echo $vm_card_number;?>"/></td>
	    <td width="49%" colspan="3"> &nbsp;<span class="style1"><?php 
	  ...
	  <tr>
	    <td width="22%">CSV 3 or 4 Digits </td>
	    <td width="26%"><input name="csv" type="text" id="csv" maxlength="18" value="<?php echo $vm_csv_digits;?>" /></td>
	    <td width="23%">Change Expiry</td>
	  ...
	  <tr>
	    <td width="22%"><strong>Pause Billing </strong></td>
	    <td colspan="4">
		<?php
	  ...
	  <tr>
	    <td width="22%"><strong>Cancel Account</strong></td>
	    <td colspan="4">
		...
		<?php echo 'Account Status: '.$acc_check ; ?>		</td>
	  	  ...
	  	  <tr>
		<td height="23" colspan="5"><input type="submit" name="Submit" id="Submit" value="Save" /></td>
	  </tr>
	</tbody>
</table>
</form>
