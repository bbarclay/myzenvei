...
<div class="docs">
<p style="text-align: right;"><span class="small">Updated: September 7, 2009</span></p>
...
including <span class=h5>Virtuemart, Community Builder,
...
<ol style="list-style-type: upper-roman;">
	...
	<ol style="list-style-type: decimal;" id="collapsibleList">
		...
		<ul id="iis" style="list-style: none">
			...
			past version of 404SEFx, and we have absolutely no idea if they are
			correct or not. Any feed back on that matter is appreciated, and may
			passed over to other people <a target="_blank" href="http://dev.anything-digital.com/Forum/39-sh404SEF/">using the support forum</a>.
...
2004-2009 Yannick Gaultier - Anything Digital<br />
