...
// saved at: 2010-03-12 16:15:30
// by: brandon (id: 63 )
// domain: http://www.zenvei.com
...
$skip = array("community");
$nocache = array("jsusernames");
$shDoNotOverrideOwnSef = array("community","jsusernames");
$shLog404Errors = "1";
$shUseURLCache = "1";
$shMaxURLInCache = "10000";
$shTranslateURL = "1";
$shInsertLanguageCode = "1";
$notTranslateURLList = array("community","jsusernames");
$notInsertIsoCodeList = array("community","jsusernames");
...
$shInsertNumericalIdCatList = array("6");
$shRedirectNonSefToSef = "0";
$shRedirectJoomlaSefToSef = "0";
$shConfig_live_secure_site = "https://www.zenvei.com";
...
$defaultComponentStringList = array("acctexp"=>"","aicontactsafe"=>"","community"=>"","contact"=>"","content"=>"","eventlist"=>"","hwdphotoshare"=>"","hwdrevenuemanager"=>"","hwdvideoshare"=>"","jafilia"=>"","jce"=>"","jcrawler"=>"","jevents"=>"","jlibman"=>"","jposition"=>"","jsusernames"=>"","jumi"=>"","jupdateman"=>"","k2"=>"","newsfeeds"=>"","search"=>"","tableeditor"=>"","user"=>"","virtuemart"=>"","weblinks"=>"","wrapper"=>"");
...
$shSecCurMonth = "Mar-2010";
$shSecLastUpdated = 1268000987;
$shSecTotalAttacks = 0;
