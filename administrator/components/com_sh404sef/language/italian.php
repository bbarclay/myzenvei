...
define('_COM_SEF_DISABLED',"<p class='error'>NOTA: Il supporto SEF in Joomla &egrave; attualmente disabilitato. Per usare SEF, attivalo da <a href='".$GLOBALS['shConfigLiveSite']."/administrator/index.php?option=com_config'>Configurazione Globale</a> pagina SEO.</p>");
...
define('_COM_SEF_TT_404PAGE','Pagina di contenuto statico da usare come pagina 404 Errore Non Trovato');
...
define('_COM_SEF_TT_ENABLED','Se settata su No sar&agrave; usato il SEF di Joomla');
...
define('_COM_SEF_TT_OLDURL','Solo reindirizzamenti relativi dalla root di Joomla <i>senza</i> la barra (slash) iniziale');
...
define('_COM_SEF_TT_SH_ADV_OVERRIDE_SEF', 'Alcuni componenti hanno i propri files sef_ext destinati ad essere usati con Joomla SEF, OpenSEF o SEF Advanced. Se questo parametro &egrave; attivo (sovrascrivi sef_ext), questa estensione di file non sar&agrave; utilizzata, e il proprio plugin sh404SEF sar&agrave; invece usato (premesso che ce ne sia uno per quel particolare componente). In caso contrario, sar&agrave; utilizzato il file sef_ext proprio del componente.');
...
define('_COM_SEF_TT_SH_META_MANAGEMENT_ACTIVATED', 'Se impostato su <strong>SI</strong>, Titolo, Descrizione, Keywords, Robots e Lingue, i META tags saranno gestiti da sh404SEF. Altrimenti, i valori originali prodotti da Joomla e/o altri componenti rimarranno invariati');
