...
define('_COM_SEF_DISABLED',"<p class='error'>MEGJEGYZÉS: A Joomla keresőbarát támogatása jelenleg letiltott. Ha használni kívánod a keresőbarát webcímeket, akkor engedélyezd az <a href='".$GLOBALS['shConfigLiveSite']."/administrator/index.php?option=com_config'>Általános beállítások</a> SEO lapján.</p>");
...
define('_COM_SEF_TT_404PAGE','Statikus tartalmi oldal használata a 404 Nem található hibák esetén');
...
define('_COM_SEF_TT_ENABLED','A Nem választása esetén a Joomla alapértelmezett keresőbarát funkcióját fogja használni a rendszer');
...
define('_COM_SEF_TT_NEWURL','Csak relatív átirányítás a Joomla gyökérből, az elején / jel <i>nélkül</i>');
...
define('_COM_SEF_TT_SH_META_MANAGEMENT_ACTIVATED', 'Az <strong>Igen</strong> választása esetén a Title, Description, Keywords, Robots és a Language META kódelemet az sh404SEF fogja kezelni. Egyéb esetben a Joomla és/vagy más komponen által produkált eredeti értékek érintetlenek maradnak. ');
...
define('_COM_SEF_SH_TOTAL_ATTACKS', 'Bloked attacks count');
