...
define('_COM_SEF_DISABLED',"<p class='error'>NOTA: Soporte para SEF en Joomla está actualmente desabilitado. Para usar SEF, hablítelo desde la<a href='".$GLOBALS['shConfigLiveSite']."/administrator/index.php?option=com_config'>Configuración Global</a> página SEO.</p>");
...
define('_COM_SEF_SH_DO_NOT_OVERRIDE_SEF_EXT', 'Utilisar Joomla o extension plugin');
...
define('_COM_SEF_TT_404PAGE','Página de contenido estático para usar con 404 no encontró errores.');
...
define('_COM_SEF_TT_OLDURL','Sólo redirección relativa a la carpeta raiz de Joomla <i>sin</i> slash al princio');
