...
define('_COM_SEF_TT_404PAGE',						'Statische Inhaltsseite welche beim Fehler: <strong>404 Seite nicht gefunden</strong> angezeigt wird<br />');
...
define('_COM_SEF_TT_SH_REDIRECT_JOOMLA_SEF_TO_SEF', 'Wenn auf <strong>Ja</strong> gesetzt, werden die CMS-Standard-SEF-URLs anstatt mit einem 301-Redirect mit dem sh404SEF-Redirect ersetzt. Wenn dieser nicht vorhanden ist, wird er automatisch erzeugt. Warning: this feature will work in most cases, but may give bad redirects for some Joomla SEF URL. Leave off if possible.');
...
define('_COM_SEF_TT_SH_META_MANAGEMENT_ACTIVATED',	'Wenn <strong>Ja</strong>, Titel, Beschreibung, Schlüsselwörter, Robots und Sprachen META Tags werden von sh404SEF verwaltet. Ansonsten bleiben die Originalwerte - erzeigt vom CMS und den Komponenten - unberührt');
...
define('_COM_SEF_TT_JOOMLA_LIVE_SITE_MISSING', 'WARNING: $live_site missing from Joomla configuration.php file!');
