 ...
 * @package     sh404SEF-15
 * @version     $Id: admin.sh404sef.html.php 1132 2010-01-16 16:11:32Z silianacom-svn $
 *
...
class HTML_sef {
  ...
  function shTextHTML( $x, $pTitle, $pToolTip, $pValue, $w1 = '200', $w2 = '150', $attrBegin = '', $attrEnd = '' ) {
    $output  = '<tr' . ( ( $x % 2 ) ? '' : ' class="row1"' ) . '>' . "\n"
    . '<td width="' . $w1 . '">' . $pTitle . '</td>' . "\n"
...
<table class="adminlist">
	...
	$x++;
  echo HTML_sef::shTextHTML( $x,
  _COM_SEF_JOOMLA_LIVE_SITE,
  _COM_SEF_TT_JOOMLA_LIVE_SITE,
  $lists['joomla_live_site'], 60, 255, '<span style="color: red;">', '</span>' );
	...
	$x++;
	echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_ALWAYS_APPEND_ITEMS_PER_PAGE,
  _COM_SEF_TT_SH_ALWAYS_APPEND_ITEMS_PER_PAGE,
  $lists['alwaysAppendItemsPerPage'] );
...
<table class="adminlist">
  ...
  <thead>
    <tr>
      <th class="title" style="text-align: left;" colspan="3"><?php echo _COM_SEF_SH_JCL_TITLE; ?></th>
    </tr>
  </thead>
  <?php
  $x = 1;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_EVENT_ID,
  _COM_SEF_TT_SH_JCL_INSERT_EVENT_ID,
  $lists['jclInsertEventId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_CATEGORY_ID,
  _COM_SEF_TT_SH_JCL_INSERT_CATEGORY_ID,
  $lists['jclInsertCategoryId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_CALENDAR_ID,
  _COM_SEF_TT_SH_JCL_INSERT_CALENDAR_ID,
  $lists['jclInsertCalendarId'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_CALENDAR_NAME,
  _COM_SEF_TT_SH_JCL_INSERT_CALENDAR_NAME,
  $lists['jclInsertCalendarName'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_DATE,
  _COM_SEF_TT_SH_JCL_INSERT_DATE,
  $lists['jclInsertDate'] );
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_JCL_INSERT_DATE_IN_EVENT_VIEW,
  _COM_SEF_TT_SH_JCL_INSERT_DATE_IN_EVENT_VIEW,
  $lists['jclInsertDateInEventView'] );
  ?>
  <!-- shumisha 2010-01-11 new params for JCalpro 2  -->
...
<table class="adminlist">
	...
	$x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_REDIRECT_CORRECT_CASE_URL,
  _COM_SEF_TT_SH_REDIRECT_CORRECT_CASE_URL,
  $lists['redirectToCorrectCaseUrl'] );
...
<table class="adminlist">
	...
	<thead>
    <tr>
      <th class="title" style="text-align: left;" colspan="3"><?php echo _COM_SEF_SH_PAGE_TITLE_TITLE; ?></th>
    </tr>
  </thead>
	<?php 
	$x++;
  HTML_sef::shTextParamHTML( $x,
  _COM_SEF_SH_PAGE_TITLE_SEPARATOR,
  _COM_SEF_TT_SH_PAGE_TITLE_SEPARATOR,
                'pageTitleSeparator',
  $sefConfig->pageTitleSeparator, 5, 15 );
	$x++;
	HTML_sef::shTextParamHTML( $x,
	...
	//-- shumisha 2010-01-15 New parameters to customize page title --
	?>
  <thead>
    <tr>
      <th class="title" style="text-align: left;" colspan="3"><?php echo _COM_SEF_SH_CONTENT_TITLE_TITLE; ?></th>
    </tr>
  </thead>
  <?php
	$x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CONTENT_TITLE_USE_ALIAS,
  _COM_SEF_TT_CONTENT_TITLE_USE_ALIAS,
  $lists['ContentTitleUseAlias'] );
  
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CONTENT_TITLE_SHOW_SECTION,
  _COM_SEF_TT_CONTENT_TITLE_SHOW_SECTION,
  $lists['ContentTitleShowSection'] );
  
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CONTENT_TITLE_USE_SEC_ALIAS,
  _COM_SEF_TT_CONTENT_TITLE_USE_SEC_ALIAS,
  $lists['ContentTitleUseSecAlias'] );
  
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CONTENT_TITLE_SHOW_CAT,
  _COM_SEF_TT_CONTENT_TITLE_SHOW_CAT,
  $lists['ContentTitleShowCat'] );
  
  $x++;
  echo HTML_sef::shYesNoParamHTML( $x,
  _COM_SEF_SH_CONTENT_TITLE_USE_CAT_ALIAS,
  _COM_SEF_TT_CONTENT_TITLE_USE_CAT_ALIAS,
  $lists['ContentTitleUseCatAlias'] );
