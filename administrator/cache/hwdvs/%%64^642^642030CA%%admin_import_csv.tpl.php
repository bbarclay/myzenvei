...
: <a href="http://documentation.hwdmediashare.co.uk/wiki/Import_Videos_from_SQL_Backup_File" target="_blank">http://documentation.hwdmediashare.co.uk/wiki/Import_Videos_from_SQL_Backup_File</a>
  <p><?php echo @_HWDVIDS_IMPT_CSV_DESC; ?>
</p>
</div>

<div style="border:1px solid #c30;color:#333333;background:#e9ddd9;font-weight: bold;text-align:left;padding:5px;margin:5px;"><?php echo @_HWDVIDS_IMPT_CSV_WARN; ?>
</div>
...
<form action="index.php" method="post" enctype="multipart/form-data">
	...
	<table cellpadding="4" cellspacing="1" border="0">
	  <!--<tr>
	    <td valign="top"><?php echo @_HWDVIDS_IMPT_MT; ?>
</td>
	    <td valign="top">
	  ...
	  <tr>
	    <td valign="top"><?php echo @_HWDVIDS_IMPT_CSV_DL; ?>
</td>
	    <td valign="top">
	  ...
	  <tr>
	    <td valign="top"><?php echo @_HWDVIDS_IMPT_CSV_ME; ?>
</td>
	    <td valign="top">
