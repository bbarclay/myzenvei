<?php
		...
		/*$con = mysql_connect('127.0.0.1', 'myzenvei_testing', 'TbTOpEgpWf7t');
		...
		{			
			...
			$regfeeQuery = "insert into jos_fixed_reg_fee set regfee = '$reg_fee', userid = '$newuser_id', regdate = now()";
	...
	$(document).ready(function()
	{
		...
		function checkEmail(params)
		{
			...
			$.ajax({  
					...
					data: "email="+ params,  
				    success: function(msg){ jQuery("#email_err").empty().append(msg); return false; }
			});
		}
//-->
</SCRIPT>
