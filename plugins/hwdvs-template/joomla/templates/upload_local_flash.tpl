...
//////
//    This file generates the display for the upload page (ADVANCED FLASH METHOD). Use caution when editing, because you might
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	{/literal}
        ...
        <form enctype="multipart/form-data" action="{$form_upld_flash}" method="post" name="hwdFlashForm">
          ...
          <!--<fieldset><legend>{$smarty.const._HWDVIDS_TITLE_UPLDYVID}</legend>-->
              <ol>
                <li id="example1">
