...
//////
//    This file generates the display for editting a video. 
//////
...
<h2 class="contentheading">{$smarty.const._HWDVIDS_TITLE_EDITVID}</h2>
<div class="standard">
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td width="150">{$smarty.const._HWDVIDS_TITLE} <font class="required">*</font></td>
      <td><input name="title" value="{$title}" class="inputbox" size="20" maxlength="50" style="width: 200px;" /></td>
    ...
    <tr>
      <td></td>
      <td colspan="2"><input name="tags" value="{$tags}" class="inputbox" size="20" maxlength="500" style="width: 200px;" /></td>
    </tr>
    <tr>
