...
//////
//    This file generates the form to create a new group.
//////
//    VARIABLES AVAILBLE IN THIS TEMPLATE FILE:                                        
//    -- $form_add_group.......URL to post the form 
//    -- $print_captcha........Only set if Captcha security is enabled
//    -- $captcha..............Contains the Captcha security image
//////
*}
...
<h2 class="contentheading">{$smarty.const._HWDVIDS_TITLE_CREATEGROUP}</h2>
<div class="standard">
