...
//////
//    This file generates the display for the group membership page, which lists all groups memberships for the current user. 
//////
...
<h2 class="contentheading">{$smarty.const._HWDVIDS_TITLE_YOURMEMBERSHIPS}</h2>
