...
//////
//    This file generates the display for the featured videos page.
//////
//    VARIABLES AVAILBLE IN THIS TEMPLATE FILE:                                        
//    -- $print_videolist.......Only set if there are any featured videos
//    -- $list..................Array containing the featured videos
//////
*}

{include file='header.tpl'}

<h2 class="contentheading">{$smarty.const._HWDVIDS_FEATURED_VIDEOS}</h2>
