...
DEFINE("_HWDVIDS_HOME_01","Welcome to hwdVideoShare [ Dannevirke ]");
...
DEFINE("_HWDVIDS_IMPT_REMOTE_DESC","Use this tool to add videos from an external source. The location can be on any server as long as the file is publicly accessible. Please note you can only add videos in the FLV video format.");
...
DEFINE("_HWDVIDS_VREMURL","URL of remote FLV video");
DEFINE("_HWDVIDS_IMGREMURL","URL of thumbnail image");
...
DEFINE("_HWDVIDS_MVAT","");
DEFINE("_HWDVIDS_MFAT","");
DEFINE("_HWDVIDS_MPAT","");
