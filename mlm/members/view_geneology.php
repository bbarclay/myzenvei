              ...
              <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D4D4C8">
                ...
                <tr> 
                 <!-- <td width="18%" height="15" bgcolor="#FFFFFF" class="blue_txt">
				  ...
				  <td width="15%" align="center" bgcolor="#FFFFFF" class="blue_txt"><div align="left"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>REPRESENTATIVE ID</strong></font></td>
                  <td width="13%" align="center" bgcolor="#FFFFFF" class="blue_txt"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>NAME</strong></font></td>
				 <td width="12%" align="center" bgcolor="#FFFFFF" class="blue_txt"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>BINARY RANK</strong></font></font></td>
				 <td width="14%" align="center" bgcolor="#FFFFFF" class="blue_txt"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>ID ENROLLED</strong></font></td>
                ...
                <? 
				  $sql3="select * from members where enroller_id='".$enrolled_id."'";
