...
$message = "User Name and pwd cannot be blank";
}
...
{
$message ="pwd cannot be blank";
}else

 if( isset($_SESSION['username']) & isset($_SESSION['pwd'])){
$sql = "select username,pwd from admin where username = '".$_SESSION['username'] ."' and pwd = '".$_SESSION['pwd']."'";
...
$message1 = "Sorry, the User Name and/or pwd you entered is not valid.";
}
                ...
                <td align="left" valign="top">
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" valign="middle"><div align="right">User 
                            Name :&nbsp;&nbsp;&nbsp;</div></td>
                        <td width="50%"><input type="text" name="username" class="TaskEdit_tf" style="width:100%"></td>
                      </tr>
                      <tr align="left" valign="top"> 
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" valign="middle"><div align="right">Password 
                            :&nbsp;&nbsp;&nbsp;</div></td>
                        <td width="50%"><input type="password" name="pwd" class="TaskEdit_tf" style="width:100%"></td>
                      </tr>
