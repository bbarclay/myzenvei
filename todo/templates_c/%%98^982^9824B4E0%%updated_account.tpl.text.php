<?php /* Smarty version 2.6.18, created on 2010-08-02 00:34:18
         compiled from notifications/updated_account.tpl.text */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'notifications/updated_account.tpl.text', 1, false),)), $this); ?>
<?php $this->_tag_stack[] = array('t', array('escape' => false,'1' => $this->_tpl_vars['app_title'])); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Your user account has been updated in %1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>.
