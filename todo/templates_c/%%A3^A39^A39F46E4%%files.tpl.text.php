<?php /* Smarty version 2.6.18, created on 2010-08-16 16:37:37
         compiled from notifications/files.tpl.text */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'textformat', 'notifications/files.tpl.text', 1, false),array('block', 't', 'notifications/files.tpl.text', 1, false),)), $this); ?>
<?php $this->_tag_stack[] = array('textformat', array('style' => 'email')); $_block_repeat=true;smarty_block_textformat($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $this->_tag_stack[] = array('t', array('escape' => false)); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This is an automated message sent at your request from<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <?php echo $this->_tpl_vars['app_title']; ?>
.
...
?>
 ...
 (<?php echo $this->_tpl_vars['data']['attachment']['files'][$this->_sections['i']['index']]['iaf_filesize']; ?>
             ...
             <?php echo $this->_tpl_vars['app_base_url']; ?>
download.php?cat=attachment&id=<?php echo $this->_tpl_vars['data']['attachment']['files'][$this->_sections['i']['index']]['iaf_id']; ?>
