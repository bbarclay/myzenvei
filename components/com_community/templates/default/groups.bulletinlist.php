...
if( $bulletins )
{
	for($i = 0; $i < count( $bulletins ); $i++ )
	{
		$row	=& $bulletins[$i];
?>
	<div id="bulletin_<?php echo $row->id; ?>" style="background-color: #e9ecf1;">
		<div class="groups-news-title" style="font-size: 14px; text-transform: capitalize;font-weight: 700;">
