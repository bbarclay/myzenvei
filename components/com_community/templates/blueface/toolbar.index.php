...
<div id="cToolbarNav">
	<ul id="community-toolbar">
		...
		?>
<!--<li class="<?php //echo $toolbarClass[TOOLBAR_APP];?> toolbar-item" id="toolbar-item-apps">
<a onmouseout="joms.toolbar.closetime()" onmouseover="joms.toolbar.open('m5')" class="has-submenu"
href="http://localhost/Brandons/site/index.php?option=com_mlm&amp;view=apps">Reports</a>
...
<a href="http://localhost/Brandons/site/index.php?option=com_mlm&amp;view=apps">Geneology Tree</a>
<a href="http://localhost/Brandons/site/index.php?option=com_mlm&amp;view=apps">Reports</a>
	...
	<li class="<?php echo $toolbarClass[TOOLBAR_APP];?> toolbar-item" id="toolbar-item-apps">
<a onmouseout="joms.toolbar.closetime()" onmouseover="joms.toolbar.open('m5')" class="has-submenu"
href="http://www.myzenvei.com/index.php?option=com_mlm&amp;view=apps">Reports</a>
<div style="overflow: hidden; visibility: hidden;" onmouseout="joms.toolbar.closetime()" onmouseover="joms.toolbar.cancelclosetime()" id="m5">

<a href="http://www.myzenvei.com/index.php?option=com_mlm&amp;view=apps">Control Panel</a>
<a href="http://www.myzenvei.com/index.php?option=com_mlm&amp;view=apps">Geneology Tree</a>
<a href="http://www.myzenvei.com/site/index.php?option=com_mlm&amp;view=apps">Reports</a>
