...
<!-- 
    groups.viewgroup.php Structure
  ...
  <div class="page-actions">
    ...
    <div class="group-main">
        ...
        <ul class="group-menus">
            ...
            <!-- Edit Group Avatar -->
            <li class="group-menu"><a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=uploadavatar&groupid=' . $group->id );?>"><?php echo JText::_('CC EDIT GROUP AVATAR');?></a></li>
            
            <!-- Edit Group -->
            <li class="group-menu"><a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=edit&groupid=' . $group->id );?>"><?php echo JText::_('CC TAB EDIT');?></a></li>
            <?php } ?>
            
            <?php if( $isCommunityAdmin ) { ?>
            <!-- Unpublish Group -->
            <li class="group-menu"><a href="javascript:void(0);" onclick="javascript:joms.groups.unpublish('<?php echo $group->id;?>');"><?php echo JText::_('CC UNPUBLISH GROUP'); ?></a></li>
            <?php } ?>
            
            <?php if( $isCommunityAdmin || ($isMine )) { ?>
            <!-- Delete Group -->
            <li class="group-menu important"><a href="javascript:void(0);" onclick="javascript:joms.groups.deleteGroup('<?php echo $group->id;?>');"><?php echo JText::_('CC DELETE GROUP'); ?></a></li>
            <?php } ?>            
          
            <?php if( (!$isMember) && !($waitingApproval) ) { ?>
            <!-- Join Group -->
            <li class="group-menu"><a href="javascript:void(0);" onclick="javascript:joms.groups.joinWindow('<?php echo $group->id;?>');"><?php echo JText::_('CC TAB JOIN GROUP'); ?></a></li>
            <?php } ?>
            
            <?php if( ($isMember) && (!$isMine) && !($waitingApproval) && (isRegisteredUser()) ) { ?>
            <!-- Leave Group -->            
            <li class="group-menu"><a href="javascript:void(0);" onclick="joms.groups.leave('<?php echo $group->id;?>');"><?php echo JText::_('CC TAB LEAVE GROUP');?></a></li>
            <?php } ?>
            
            <?php if( ($isAdmin) || ($isMine) || ($isMember) ) { ?>
            <!-- Invite Friend -->            
            <li class="group-menu"><a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=invitefriends&groupid=' . $group->id);?>"><?php echo JText::_('CC TAB INVITE');?></a></li>
            <?php } ?>
        </ul>
        <!-- Group Menu -->
...
<div class="group-bottom">
    ...
    <!-- Group Members -->
    <div id="community-group-members" class="app-box group-members">
        <div class="app-box-header">
            <h2 class="app-box-title"><?php echo JText::sprintf('CC MEMBERS');?></h2>
        </div>
        <div class="app-box-actions">
            <?php echo JText::sprintf( (cIsPlural($membersCount)) ? 'CC MEMBERS COUNT MANY':'CC MEMBERS COUNT' , $membersCount ); ?>        
        </div>
        <div class="app-box-content">
            ...
            if($members)
            {
                ...
                {
            ?>
                <li class="group-member"><a href="<?php echo cUserLink($member->id); ?>"><img border="0" class="avatar jomTips" src="<?php echo $member->getThumbAvatar(); ?>" title="<?php echo cAvatarTooltip($member);?>" alt=""/></a></li>
            <?php
                }
            }
            ?>
    ...
    <!-- Group Bottom: Group Main -->
    <div class="group-main">
        <?php if( $group->approvals=='0' || $isMine || $isMember || $isCommunityAdmin ) { ?>
        
        <!-- Group News -->
        <div id="community-group-news" class="app-box group-news">
            <div class="app-box-header">
        ...
        <div id="community-group-dicussion" class="app-box group-discussion">
            <div class="app-box-header">
        ...
        <div id="community-group-photos" class="app-box group-photos">
            <div class="app-box-header">            
            ...
            <div class="app-box-footer">
				<div class="app-box-info"><?php echo JText::sprintf( 'CC DISPLAYING ALBUMS COUNT' , count($albums) , $totalAlbums ); ?></div>
                <div class="app-box-actions">
                    <?php
        ...
        <div id="community-group-videos" class="app-box">	                
            ...
            <div class="app-box-content">	                	
            	...
            	<?php if($videos){ ?>
                    ...
                    <div class="clr"></div>
				<?php }else{ ?>
                	<div><?php echo JText::_('CC NO VIDEOS'); ?></div>
				<?php } ?>
            	</div>
            </div>
