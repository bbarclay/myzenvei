...
class CAvatarLibrary {
	...
	function CAvatarLibrary( $path = null , $forceCreate = false)
	{
	 ...
	 */	
	function draw( $filename , $image , $width , $thumbnail = false, $maxWidth = false)
	{
	...
	function _create( $file , $sourceX , $sourceY , $width , $height , $currentWidth , $currentHeight)
	{
