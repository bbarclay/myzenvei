...

{
...

	{
		...
		$k_link               = JRequest::getString('k_link', '', 'post');
		...
		//Your Name:*  would like to invite you to view this link __(get page link)__.
		
		$msg = "$sender  would like to invite you to view this link $link";
