...
class hwd_vs_groups
{
    ...
    function groups()
	{
		global $mainframe, $limitstart, $hwdvs_joing, $hwdvs_selectg;
    ...
    function savegroup()
	{
		...
		if ($c->disablecaptcha == "0") {
			...
			if(($_SESSION['security_code'] == $_POST['security_code']) && (!empty($_SESSION['security_code'])) ) {
				...
				$msg = _HWDVIDS_ALERT_ERRSC;
				echo "<div id=\"hwdvids\">";
				hwd_vs_html_nav::navigation(3);
				hwd_vs_html_nav::usernavigation(0);
				echo "<img src=\"".$mosConfig_live_site."/components/com_hwdvideoshare/images/icons/exclamation.png\" />&nbsp;&nbsp;".$msg."<br /><br />";
				hwd_vs_html_footer::tidyup();
				echo "</div>";
				return;
			}
