...
//******************************************************************************************************
	...
	$mainframe->addCustomHeadTag($uutemplate_css);
	$mainframe->addCustomHeadTag($uu_js);
	$mainframe->addCustomHeadTag('<meta http-equiv="pragma" content="no-cache">');
	$mainframe->addCustomHeadTag('<meta http-equiv="cache-control" content="no-cache">');
	$mainframe->addCustomHeadTag('<meta http-equiv="expires" content="-1">');
	$mainframe->addCustomHeadTag('<meta name="robots" content="index,nofollow">');
	$mainframe->addCustomHeadTag('<meta name="robots" content="index,nofollow">');
...
//******************************************************************************************************
	...
	$uu_upload_form.= "<form name=\"form_upload\" id=\"form_upload\" ".$addon0." method=\"post\" enctype=\"multipart/form-data\" action=\"#\" style=\"margin: 0px; padding: 0px;\">
				  ...
				  <!-- Include extra values you want passed to the upload script here. -->
					<input type=\"hidden\" name=\"videotype\" value=\"".stripslashes($videotype)."\" />
					...
					<input type=\"hidden\" name=\"Itemid\" value=\"".stripslashes($Itemid)."\" />
					<input type=\"hidden\" name=\"livesite\" value=\"".stripslashes(JURI::base())."\" />
