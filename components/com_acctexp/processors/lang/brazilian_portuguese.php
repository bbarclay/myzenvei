...
define( '_AEC_USERFORM_BILLING_DETAILS_NAME', 'Detalhes de Cobrança');
define( '_AEC_USERFORM_SHIPPING_DETAILS_NAME', 'Detalhes de Envio');
define( '_AEC_USERFORM_BILLFIRSTNAME_NAME', 'Nome');
define( '_AEC_USERFORM_BILLLASTNAME_NAME', 'Sobrenome');
define( '_AEC_USERFORM_BILLADDRESS_NAME', 'Endereço');
define( '_AEC_USERFORM_BILLADDRESS2_NAME', 'Número');
define( '_AEC_USERFORM_BILLCITY_NAME', 'Cidade');
define( '_AEC_USERFORM_BILLNONUS_NAME', '&larr; check if Non-U.S. (State &amp; Zip not required)');
define( '_AEC_USERFORM_BILLSTATE_NAME', 'Estado');
define( '_AEC_USERFORM_BILLSTATEPROV_NAME', 'Bairro');
define( '_AEC_USERFORM_BILLZIP_NAME', 'CEP');
define( '_AEC_USERFORM_BILLCOUNTRY_NAME', 'País');
define( '_AEC_USERFORM_BILLPHONE_NAME', 'Telefone');
define( '_AEC_USERFORM_BILLFAX_NAME', 'Fax');
define( '_AEC_USERFORM_BILLCOMPANY_NAME', 'Empresa');
