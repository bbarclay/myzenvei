...
global $limitstart, $limit, $mainframe, $Itemid, $task, $joinv, $joing, $select;
...
hwdpsInitialise::background();
hwdpsInitialise::language();
hwdpsInitialise::itemid();
if (!hwdpsInitialise::template()) {return;}
hwdpsInitialise::revenueManager();
hwdpsInitialise::mysqlQuery();
hwdpsInitialise::definitions();
if (!hwd_ps_access::checkAccess($c->gtree_core, $c->gtree_core_child, 1, 0, _HWDPS_TITLE_NOACCESS, _HWDPS_ALERT_REGISTERFORACCESS, _HWDPS_ALERT_NOT_AUTHORIZED, 'exclamation.png', 0)) {return;}
