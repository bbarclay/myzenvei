...
*/
  ...
  var autoship_update_total = function () {
    ...
    $('.autoship_total').html(products_total.toFixed(2));
  };
  ...
  $('input[name^=autoship[products]]').change(function (event) {
    var sku = $(event.target).attr('id').replace(/autoship\_quantity\_/, '');
