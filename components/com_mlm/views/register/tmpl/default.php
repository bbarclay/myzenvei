...
<form id="reg_form" action="index.php?option=com_mlm&controller=user&task=register_save" method="POST">
  ...
  <div>
    ...
    <div class="labeltop">
      <label class="lbl" for="enrollment_type">Enrollment Type:</label>
      ...
      <!-- TODO -->
      <label class="lbl" for="builder_packs">Builder Packs:</label>
  ...
  <div id="tab-container" class="tabs">
    ...
    <div id="terms_conditions">
      <div class="zn_terms">
        ...
        <p class="zn_approve">Congratulations! This will submit your enrollment and your order will be shipped within 72 hours. You should talk with your Referring Associate immediately for any questions and information you require. Thank you for your interest in Zenvei International!</p>
