...
<div id="zn_package">
  <table>
    ...
    <tr id="row_signup_fee">
      <th class="border">  <?php echo JText::_('CLI_FLOAT_PRODUCT_ORD');?>REGIST. FEE</td>
    ...
    <?php echo JText::_('CLI_FLOAT_PRODUCT_ORD');?>Your AutoShip order will be charged monthly at an amount of $<span id="autoship_amount">0.00</span>
</div>
