...
include_once '../members/settings.inc';
?>
...
<html>
    ...
    <body>
		...
		<div id="content">
<?php include '../fisheye/index.html';?> 
            ...
            <div id="menuWrapper" class="menuWrapper bg1">
                <ul class="menu" id="menu">
                    <li class="bg1" style="background-position:0 0;">
                        <a id="bg1" href="../../../index.php?option=com_mlm&page=view_geneology_graph">DOWNLINE</a>
                        <ul class="sub1" style="background-position:0 0;">
                            <li><a href="../../../index.php?option=com_mlm&page=view_geneology_graph">Tree View       </a></li>
                            <li><a href="../../../index.php?option=com_mlm&page=view_geneology">List View        </a></li>
                            <li><a href="../../../index.php?option=com_mlm&page=view_reports">Custom Reporting         </a></li>
                        </ul>
                    </li>
                    <li class="bg1" style="background-position:-266px 0px;">
                        <a id="bg2" href="#">Numbers</a>
                        <ul class="sub2" style="background-position:-266px 0;">
                            <li><a href="../../../index.php?option=com_mlm&page=view_reports_archieves">Earnings</a></li>
                            <li><a href="../../../index.php?option=com_mlm&page=view_reports">Custom Reports</a></li>
                            <li><a href="#">Realtime</a></li>
                        </ul>
                    </li>
                    <li class="last bg1" style="background-position:-532px 0px;">
                        <a id="bg3" href="#">Access</a>
                        <ul class="sub3" style="background-position:-266px 0;">
                            <li><a href="../../../index.php?option=com_community&view=profile&userid=<?php echo $CustomUid; ?>&Itemid=15">Profile</a></li>
                            <li><a href="#">Autoship</a></li>
                            <li><a href="../../../index.php?option=com_community&view=frontpage&Itemid=15">Community Home</a></li>
                        </ul>
                  </li>
                </ul>
            </div>
