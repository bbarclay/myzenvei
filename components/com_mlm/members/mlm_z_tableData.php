...
<table cellpadding="2" cellspacing="2" border="0" class="display" id="example" style="margin-top:10px;">
	...
	?>
		...
		<tr>
            ...
            <?php echo "<td>".number_format($row['commissions'],2)."</td>";?> 
            <?php echo "<td>".number_format($row['commission_match'],2)."</td>";?>
			<?php //echo "<td>".$row['fast_match']."</td>";?>
			<?php echo "<td>".$row['preferred']."</td>";?> 
			
            <?php echo "<td>".number_format($row['preferred_match'],2)."</td>";?>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  <tr>
	...
	<tr style= "background-color: #FF6600; color:#FFFFFF;">
		...
		<td colspan="" align="right" ><?php echo number_format($carry,2); ?>&nbsp; $</td>
	</tr>
	
	<tr style= "background-color: #FF6600; color:#FFFFFF;" >
		<td colspan="" align="right"><b>Grand Total : </b></td>
		<td colspan="" align="right" ><?php echo number_format($total+$carry,2); ?>&nbsp; $</td>
	</tr>
