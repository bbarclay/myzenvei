...
$message ="Password cannot be blank";
 ...
 {
$sql = "select username,password from company where username = '".$_SESSION['username'] ."' and
 password = '".$_SESSION['password']."'";
$result = mysql_query($sql);

$results = mysql_fetch_array($result) or die ('Error: '.mysql_error ());
              ...
              <tr>
                <td align="left" valign="top">
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" height="20" valign="bottom"><strong>Dealers 
                        ...
                        <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td width="19" align="center" ><div align="right"> 
                                  <input type="submit" name="Submit" value="Login As Dealer" class="TaskEdit_tf">
                                </div></td>
                            </tr>
                          </table></td>
                      </tr>
