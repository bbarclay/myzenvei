...
if( $_POST)
{
	...
	if(empty($message1))
	{
			$sql =	 "update ".$compname." set tip='".$tip."'";
			$result = mysql_query($sql);	
			$message="Tip Updated Globally";
	}
}
?>
              ...
              <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D4D4C8">
                ...
                <tr> 
                  <td height="19" colspan="2" bgcolor="#EFEFE7" class="blue_txt"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>:: 
                    &nbsp;Update Tip Globally</strong></font></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td width="24%" height="15" bgcolor="#FFFFFF" class="blue_txt"><div align="right"><font color="#990000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Tip 
                       :</font></strong></font></div></td>
                  <td bgcolor="#FFFFFF" class="blue_txt"><input name="tip" type="text" id="tip" size="40"> 
