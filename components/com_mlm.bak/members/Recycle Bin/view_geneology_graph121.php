...
<script type='text/javascript'> 
  ...
  $(".o1").jqDock({size:80,distance:54,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
  $(".o2").jqDock({size:50,distance:54,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
  $(".o3").jqDock({size:30,distance:40,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
  
  $(".o4").jqDock({size:70,distance:54,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
  
  $(".o5").jqDock({size:40,distance:54,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});  
