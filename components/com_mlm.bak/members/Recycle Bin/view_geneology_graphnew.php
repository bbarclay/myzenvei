...
//$_SESSION['parent']=63; // this will be replace later on with cookies or session.
...
<script src="scripts/jquery_002.js" type="text/javascript" ></script> 
    ...
    $(document).ready(function(){		
		...
		$(".o1").jqDock({size:80,distance:80,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
		$(".o2").jqDock({size:50,distance:54,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
		$(".o3").jqDock({size:30,distance:35,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
		
		$(".o4").jqDock({size:70,distance:70,coefficient:1.5,duration:500,align:'middle',labels:false,source:false,loader:null});
...
<a href="http://localhost/Brandons/site/index.php?option=com_mlm&amp;view=apps">Control Panel
</a>&nbsp; &nbsp;<a href="view_geneology_graph.php?tree_Id=63">Parent Tree</a>
</a>&nbsp; &nbsp;<a href="http://www.myzenvei.com/index.php?option=com_community&view=profile&userid=66&Itemid=15">Profile</a>
...
<?php } ?>	
<div id="txtHint" style="position:absolute; left:10px; top:352px"  class="tooltip"><b>Person info will be listed here.</b></div>
