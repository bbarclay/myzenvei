	    ...
	    <tr>
			...
			<td width="100">
		        <div style="padding: 2px 5px 0; margin: 0;">
			        <a class="add" style="text-indent: 0; padding-left: 20px;" href="javascript:void(0);" onclick="jax.call('community' , 'friends,ajaxApproveRequest' , '<?php echo $row->connection_id; ?>');">
