...
<div id="apps-core" class="app-box">
<div class="app-box-header">
	<div class="app-box-header">
		<h2 class="app-box-title"><?php echo JText::_('CC CORE APPLICATIONS'); ?></h2>
	</div>
</div>				
...
<div id="apps-mine" class="app-box">
<div class="app-box-header">
	<div class="app-box-header">
		<h2 class="app-box-title"><?php echo JText::_('CC INSTALLED APPLICATIONS'); ?></h2>
	</div>
</div>				
<div class="app-box-content">
