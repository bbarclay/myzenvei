...
<input type="hidden" id="reg_fee" value="00.00" />
...
<div id="step1">
    ...
    <p>&nbsp;</p>
    <p><a href="http://www.zenvei.com/signupnoregfee.php">Click here</a> to order products without creating an autoship order >></p>
    <p>&nbsp;</p>
...
<!--        <tr id="row_signup_fee">
        ...
        <tr>
            ...
            <td align="right" style="border-bottom: 0px solid #d5d6d0; padding: 5px 0px 5px 0px; text-align: right">
                $<span id="total_amount" style="font-weight: bold; font-size: 14px;">0.00</span>
            </td>
        </tr>
    </table>
