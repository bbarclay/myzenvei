...
function jsUsernameCheck($name)
{
	...
	else
	{
		...
		if(!empty($id))
		{
			...
			header("Location: http://www.myzenvei.com/index.php?affiliate=$id&name=$subdomain");
			//header("Location: index.php?option=com_community&userid=$id&view=profile&affiliate=$id&Itemid=15");
			exit();
		}
