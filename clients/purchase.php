...
$memberShipquery = "select  * from mlm_geneology_tree where userid= '$userID'";
$membershipRes = mysql_query($memberShipquery);
$memberShipqueryData = mysql_fetch_array($membershipRes);
$memberGroup = $memberShipqueryData['shopperid'];

if($memberGroup=="8")
   #product prices 
    {$p1 = 32; $p2 = 35; $p3 = 32; $p4 = 32; $myzGroupName = " Business Associate";}
else if($memberGroup=="6") 
 	{$p1 = 35; $p2 = 38; $p3 = 35; $p4 = 35; $myzGroupName = " Marketing Associate";}

if(!$memberGroup)
 	{$p1 = 35; $p2 = 38; $p3 = 35; $p4 = 35; $myzGroupName = " No AutoShip";}
...
<h1>ZENVEI</h1>
    ...
    <input type="hidden" value="<?php echo $memberGroup; ?>" name="tp1" id="tp1" />
    
	<p>
      
       <strong><?php echo $myzGroupName; ?></strong>
...
<div id="step1">
    ...
    <table cellspacing="0" width="70">
        <tr>
          ...
          <td width="30" align="left" class="b">$<span id="rprice"><?php echo  $p1; ?></span><!--<span class="bus">32</span><span class="mar">35</span> --></td>
          <td width="118">
        ...
        <tr>
          ...
          <td align="left" class="b">$<span id="bprice"><?php echo  $p2; ?></span></td>
        ...
        <tr>
          ...
          <td align="left" class="b">$<span id="gprice"><?php echo $p3; ?></span></td>
        ...
        <tr>
          ...
          <td align="left" class="b">$<span id="sprice"><?php echo $p4; ?></span></td>
