...
<div id="step2">
    ...
    <table cellspacing="0" width="100%">
        ...
        <tr>
          <td>*Username</td>
          <td>
		  <input id="username"  type="text" name="username" onBlur="checkUsername(this.value)" /> 
...
Replicated Site ID</td>
        <td><input id="replicated_siteid"  type="text" name="replicated_siteid" onBlur="checkRep(this.value)" /></td>
        </tr>
