...
-->
		...
		<p align="left"><img src="../images/header.jpg" alt="header" width="903" height="105" border="0" usemap ="#Map" />
...
<h1>ZENVEI</h1>
	<form id="form1" name="form1" method="post" action="">
			...
			<table border="0" align="left" cellpadding="2" cellspacing="2" width="80%">

	<tr>
	  <td colspan="5"><a href="purchase.php">Home</a> | <a href="EditAutoShip.php">Update AutoShip</a> | <a href="login.php?action=logout">Logout </a></td>
	  </tr>
	<tr>
     ...
     <td colspan="5"><strong>Change Options </strong></td>
	  ...
	  <tr>
	    <td colspan="5"><span class="style2"><?php 
		  ...
		  echo 'Uername : ' .$_SESSION['username'];
		  echo '&nbsp;&nbsp;&nbsp;&nbsp;';
	  ...
	  <tr>
	    <td colspan="4"><strong>Update CreditCard Information </strong></td>
       </tr>
	  <tr>
	    <td>Card Type</td>
	    <td> 
