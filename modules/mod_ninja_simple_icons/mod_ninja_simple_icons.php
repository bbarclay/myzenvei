...
// set up all the globals
  ...
  $acl = &JFactory::getACL();
	...
	$siteLoc = JURI::base().'modules/mod_ninja_simple_icons/assets';
   ...
   <div>
    <ul>                
       <?php /* loop through our menu items and display the ones we need to display */ 
        ...
        ?>
               <li>
                  <a href="<?php echo $iconParams[$i][3]; ?>" target="<?php echo $iconParams[$i][5]; ?>">
                  <img src="<?php echo $siteLoc.'/images/'.$iconParams[$i][1]; ?>" title="<?php echo $iconParams[$i][2]; ?>" alt="<?php echo $iconParams[$i][4]; ?>" height="<?php echo $icon_height; ?>" width="<?php echo $icon_width; ?>" />
                  <?php if ($orien == 'horiz' || $orien == 'vert') : ?><br /><?php endif; ?>
                  <?php if ($icon_titles == 0) { ?>
